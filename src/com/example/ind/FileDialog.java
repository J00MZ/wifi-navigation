...
public class FileDialog extends ListActivity {
	 ...
	 * Diretorio raiz.
	 */
	private static final String ROOT = Environment.getExternalStorageDirectory()+ "/WifiNavigation/";
		...
		selectButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (selectedFile != null) {
					...
					String floorKey = "FILENAME";
					String fileName = prefs.getString(floorKey, "default!");
					Toast.makeText(getApplicationContext(), "old File = " + fileName, Toast.LENGTH_LONG).show();
					
					Editor edit = prefs.edit();
					edit.putString(floorKey, selectedFile.getName());
					edit.commit();
					
					Toast.makeText(getApplicationContext(), "File Selected: " + selectedFile.getName() +
							"\nBackground will be updated to new file.", Toast.LENGTH_SHORT).show();
					finish();
				}
			}
		});
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (file.isDirectory()) {
			...
			if (file.canRead()) {
				...
				new AlertDialog.Builder(this).setIcon(R.drawable.wifi_icon_hi)
